...
def phypox_stream(url,poll_interval=0.05):
    while True:
        try: 
            ...
            yield 0, 0  # fallback no movement
...
def main():
    ...
    # Phypox Stream set-up
    url = "http://10.143.194.122:8080/get?accX&accY"
    accel_gen = phypox_stream(url)
    #Movement Smoothing
    x_prev, y_prev = 0,0
    alpha = 0.2 
